...
After an interruption, run the helper without options to check what remains.
Keep the journal unchanged and follow the printed next steps rather than
starting a manual rotation. If the helper reports unavailable daemons, check
the affected nodes and service logs rather than assuming their keys need repair.
