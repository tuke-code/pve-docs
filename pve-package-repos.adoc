...
Outdated: {pve} VE 1 to 6 Repositories
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

The following {pve} releases are very outdated and are archived:

* {pve} 1, based on Debian 5 ``lenny''
* {pve} 2, based on Debian 6 ``squeeze''
* {pve} 3, based on Debian 7 ``wheezy''
* {pve} 4, based on Debian 8 ``jessie''
* {pve} 5, based on Debian 9 ``stretch''
* {pve} 6, based on Debian 10 ``buster''

For {pve} 3 and newer from above list, repositories are still available on our
archive CDN.

See the shipped version of the reference documentation on your installation of
such legacy releases for details about the repositories.

NOTE: You will need to change the repo domain from  ``enterprise.proxmox.com'' or
``download.proxmox.com'' to ``archive.proxmox.com''.
